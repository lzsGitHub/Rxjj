...
public class MagicArray extends View {
    public MagicArray(Context context) {
        this(context,null);
    }

    public MagicArray(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MagicArray(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
